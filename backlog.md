- Make all tests run on new grammar
    ...
    - =(LEN(B2)-LEN(SUBSTITUTE(B2,"appos", "")))/LEN(TRIM("appos"))
    - Make a search function that can find the MRS with criteria
        Figure out the MRS for "my son johnny and me"
            [ "my son johnny and me"
              TOP: h0
              INDEX: e2 [ e SF: prop ]
              RELS: < [ unknown<0:20> LBL: h1 ARG: x4 [ x PERS: 3 NUM: pl ] ARG0: e2 ]
                      [ udef_q<0:20> LBL: h5 ARG0: x4 RSTR: h6 BODY: h7 ]
                      [ appos<0:13> LBL: h8 ARG0: e9 [ e SF: prop TENSE: untensed MOOD: indicative PROG: - PERF: - ] ARG1: x10 [ x PERS: 3 NUM: sg IND: + ] ARG2: x11 [ x PERS: 3 NUM: sg IND: + ] ]
                      [ def_explicit_q<0:2> LBL: h12 ARG0: x10 RSTR: h13 BODY: h14 ]
                      [ poss<0:2> LBL: h15 ARG0: e16 [ e SF: prop TENSE: untensed MOOD: indicative PROG: - PERF: - ] ARG1: x10 ARG2: x17 [ x PERS: 1 NUM: sg PT: std ] ]
                      [ pronoun_q<0:2> LBL: h18 ARG0: x17 RSTR: h19 BODY: h20 ]
                      [ pron<0:2> LBL: h21 ARG0: x17 ]
                      [ _son_n_of<3:6> LBL: h15 ARG0: x10 ARG1: i22 ]
                      [ proper_q<7:13> LBL: h23 ARG0: x11 RSTR: h24 BODY: h25 ]
                      [ named<7:13> LBL: h26 ARG0: x11 CARG: "Johnny" ]
                      [ _and_c<14:17> LBL: h8 ARG0: x4 ARG1: x10 ARG2: x28 [ x PERS: 1 NUM: sg IND: + PT: std ] ]
                      [ pron<18:20> LBL: h29 ARG0: x28 ]
                      [ pronoun_q<18:20> LBL: h30 ARG0: x28 RSTR: h31 BODY: h32 ] >
              HCONS: < h0 qeq h1 h6 qeq h8 h13 qeq h15 h19 qeq h21 h24 qeq h26 h31 qeq h29 > ]

            -- CHOSEN Parse #0, CHOSEN Tree #1:

                                                         ┌────── pron(x17)
                                 ┌────── pronoun_q(x17,RSTR,BODY)    ┌── _son_n_of(x10,i22)
                                 │                            └─ and(0,1)
                                 │                                     └ poss(e16,x10,x17)
            def_explicit_q(x10,RSTR,BODY)
                                      │                                                                         ┌── _and_c(x4,x10,x28)
                                      │                 ┌────── named(Johnny,x11)                               │
                                      │                 │                                           ┌────── and(0,1)
                                      └─ proper_q(x11,RSTR,BODY)                ┌────── pron(x28)   │             │
                                                             │                  │                   │             └ appos(e9,x10,x11)
                                                             └─ pronoun_q(x28,RSTR,BODY)            │
                                                                                     └─ udef_q(x4,RSTR,BODY)
                                                                                                         └─ unknown(e2,x4)
        Figure out the the MRS for "Just two"
            [ "just two"
              TOP: h0
              INDEX: e2 [ e SF: prop-or-ques ]
              RELS: < [ unknown<0:8> LBL: h1 ARG: x4 [ x PERS: 3 NUM: sg ] ARG0: e2 ]
                      [ _just_a_1<0:4> LBL: h1 ARG0: e5 [ e SF: prop ] ARG1: e2 ]
                      [ number_q<5:8> LBL: h6 ARG0: x4 RSTR: h7 BODY: h8 ]
                      [ card<5:8> LBL: h9 ARG0: x4 ARG1: i11 CARG: "2" ] >
