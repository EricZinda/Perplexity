...
def solution_groups(execution_context, solutions_orig, this_sentence_force, wh_question_variable, tree_info, all_groups=False, all_unprocessed_groups=None, criteria_list=None):
    ...
    at_least_one_solutions = at_least_one_generator(solutions_orig)
    original_error_info = execution_context.get_error_info()
    if at_least_one_solutions:
        # Returning errors:
        ...
        for lineage_solutions in SolutionTreeSetGenerator(at_least_one_solutions):
            # Go through each set of solutions that was generated by a single "lineage"
            # meaning one set of predication implementations
