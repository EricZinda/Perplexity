{
    ...
    "TestItems": [
        ...
        },
        {
            ...
            "Expected": "I don't know the words: good, point<end>I don't know the words: part_of",
            "Tree": "None<end>None",
            "Enabled": true,
        ...
        },
        {
            ...
            "Expected": "Hello!<end>Host: Perfect! Please come right this way. The host shows you to a wooden table with a checkered tablecloth. A minute goes by, then your waiter arrives.\nWaiter: Hi there!\nWaiter: What can I get you?",
        ...
        },
        {
            ...
            "Tree": "_okay_a_1(i6,unknown(e2,u5))<end>pronoun_q(x3,pron(x3),_the_q(x8,named(Steak,x8),_order_v_1(e2,x3,x8)))<end>_please_a_1(i22,pronoun_q(x9,pron(x9),_the_q(x16,[_salad_n_1(x16), _green_a_2(e21,x16)],def_explicit_q(x3,[_son_n_of(x3,i14), poss(e8,x3,x9)],_have_v_1(e2,x3,x16)))))",
            "Enabled": true,
