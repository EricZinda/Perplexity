{
    ...
    "TestItems": [
        ...
        },
        {
            ...
            "Expected": "Yes, that is true.\nWaiter: Can I get you anything besides 2 steaks for you?",
            "Tree": "pronoun_q(x9,pron(x9),udef_q(x14,_a_q(x19,_steak_n_1(x19),_a_q(x24,_steak_n_1(x24),_and_c(x14,x19,x24))),def_explicit_q(x3,[_order_n_of(x3), poss(e8,x3,x9)],_be_v_id(e2,x3,x14))))",
            "Enabled": true,
