{
    ...
    "TestItems": [
        ...
        },
        {
            ...
            "Expected": "(File(name=/temp/59.txt, size=1000),)(File(name=/documents/file1.txt, size=1000),)(File(name=/Desktop/the yearly budget.txt, size=10000000),)(File(name=/Desktop/blue, size=10000000),)(there are more)",
        ...
        },
        {
            ...
            "Expected": "(File(name=/temp/59.txt, size=1000),)(File(name=/documents/file1.txt, size=1000),)(there are more)",
        ...
        },
        {
            ...
            "Expected": "(File(name=/Desktop/the yearly budget.txt, size=10000000), File(name=/Desktop/blue, size=10000000))(there are more)",
        ...
        },
        {
            ...
            "Expected": "(File(name=/Desktop/file2.txt, size=10000000),)(File(name=/Desktop/file3.txt, size=10000000),)(there are more)",
