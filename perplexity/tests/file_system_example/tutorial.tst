{
    ...
    "TestItems": [
        ...
        },
        {
            ...
            "Tree": "_this_q_dem(x22,_folder_n_of(x22,i27),udef_q(x3,proper_q(x8,[quoted(blue,i12), fw_seq(x8,i12)],proper_q(x15,[quoted(59.txt,i20), fw_seq(x15,i20)],_and_c(x3,x8,x15))),_in_p_loc(e2,x3,x22)))",
            "Enabled": true,
        ...
        },
        {
            ...
            "Tree": "udef_q(x3,proper_q(x8,[quoted(bigfile.txt,i12), fw_seq(x8,i12)],proper_q(x15,[quoted(59.txt,i20), fw_seq(x15,i20)],_and_c(x3,x8,x15))),_large_a_1(e2,x3))",
            "Enabled": true,
