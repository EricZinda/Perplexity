...
def Predication(vocabulary, name=None):
    ...
    def PredicationDecorator(function_to_decorate):
        ...
        vocabulary.add_predication(function_to_decorate.__module__, function_to_decorate.__name__, predication_name)
...
class Vocabulary(object):
    ...
    def add_predication(self, module, function, delphin_name):
