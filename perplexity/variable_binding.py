...
class VariableData(object):
    ...
    def __init__(self, name, value_type=VariableValueType.none, determiner=None, used_collective=False, quantifier=None):
        self.name = name
    ...
    def copy_with_changes(self, value_type=None, determiner=None, used_collective=None, quantifier=None):
