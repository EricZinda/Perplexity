...
A described in [the section on backtracking](devcon0010MRSSolver), our idealized approach to solving it is:
...
[Perplexity Internals](../pxint/pxint0105ErrorsChoosingWhichFailure) gives a good example of how Perplexity registers and reports failures using this approach.
