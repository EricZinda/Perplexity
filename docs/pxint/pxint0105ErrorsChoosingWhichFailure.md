...
As described in the conceptual topic on [Choosing a Failure](../devcon/devcon0080ErrorsChoosingWhichFailure), a good heuristic to use for reporting failures to the user is to pick the "deepest" failure encountered. Here we'll walk through how Perplexity does that.
