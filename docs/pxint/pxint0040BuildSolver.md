...
The `Example2()` function shows how we can use all of this to call a predication using the simple solver. With this in place, we can tackle more complicated groups of predications such as conjunctions in the [next section](./pxint0050Conjunctions).
