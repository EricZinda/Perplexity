...
The rest of this section will give you a base understanding of the MRS formalism so that we can explore how to build these well-formed trees in a [later section](https://blog.inductorsoftware.com/Perplexity/home/mrscon/devhowto0020WellFormedTree) and ultimately write software that derives the speaker's intended meaning from them.  Deriving their intended meaning is the topic of this entire tutorial.
