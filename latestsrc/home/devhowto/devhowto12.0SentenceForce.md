...
You can see what *type* of phrase it is by looking at the [*properties* of that variable](https://blog.inductorsoftware.com/Perplexity/home/devhowto/devhowtoMRS). This is the first time we've had to inspect variable properties, so lets dig in there a bit. 
...
Last update: 2023-05-14 by EricZinda [[edit](https://github.com/EricZinda/Perplexity/edit/main/docs/devhowto/devhowto12.0SentenceForce.md)]{% endraw %}