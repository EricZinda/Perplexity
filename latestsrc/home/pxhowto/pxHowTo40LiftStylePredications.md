...
Not all words are associative with sets like "in" from the [previous section](https://blog.inductorsoftware.com/Perplexity/home/pxhowto/pxHowTo30InStylePredications): The verb "to lift" interprets sets vs. individuals as very different things.  For example:
...
So, `lift_style_predication_1()` works very much like the `in_style_predication_1()` from the [previous section](https://blog.inductorsoftware.com/Perplexity/home/pxhowto/pxHowTo30InStylePredications) but calls the check function with sets.  
...
## Running the Example
As is, we can't really run the table. We need to teach the system "students" and "tables" first.  This is easy enough using the approach we used in our [first topic](https://blog.inductorsoftware.com/Perplexity/home/pxhowto/pxHowTo20ImplementAPredication) about files:
...
Next we will tackle [event predications](https://blog.inductorsoftware.com/Perplexity/home/pxhowto/pxHowTo50EventPredications) so that we can handle words like "very" and other modifiers.


Last update: 2023-05-15 by EricZinda [[edit](https://github.com/EricZinda/Perplexity/edit/main/docs/pxHowTo/pxHowTo40LiftStylePredications.md)]{% endraw %}