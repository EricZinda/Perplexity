...
class State(object):
    ...
    def set_x(self, variable_name, item, cardinal_id=None, cardinal_item_id=None, is_collective=None):
        ...
        new_state.variables[variable_name] = VariableBinding(VariableData(variable_name, cardinal_id, cardinal_item_id, is_collective), item)
